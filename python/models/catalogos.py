...
class Sucursales(db.Model,BaseMixin,AuditMixin):
    ...
    nombre = db.Column(db.String(255), nullable=False)
    direccion = db.Column(EncryptedColumn(255), nullable=True)
...
class Clientes(db.Model,BaseMixin,AuditMixin):
    ...
    direccion = db.Column(EncryptedColumn(255))
    numero_exterior = db.Column(EncryptedColumn(255))
    numero_interior = db.Column(EncryptedColumn(255))
...
class CuentasDeBanco(db.Model,BaseMixin,AuditMixin):
    ...
    numero_de_cuenta = db.Column(EncryptedColumn(255),nullable=False)
    clabe = db.Column(EncryptedColumn(255),nullable=False)
